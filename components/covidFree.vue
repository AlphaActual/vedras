<template>
    <section class="ptb-xxl plr-xxl covid-section">
        <div class="covid-image mr-xs"></div>
        <div class="covid-text ml-xs plr-lg ptb-md">
...
.covid-image { 
    background-image: url('~assets/images/1_9JdjVS0SJanGma8Nt63dGw (1).jpg');
